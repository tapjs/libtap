...
class Test extends Base {
  ...
  hasProp (found, wanted, message, extra) {
    [message, extra] = normalizeMessageExtra('should have the named property, which is not undefined', message, extra)
  ...
  hasOwnProp (found, wanted, message, extra) {
    [message, extra] = normalizeMessageExtra('should have the named own property, which is not undefined', message, extra)
  ...
  hasProps (found, wanted, message, extra) {
    [message, extra] = normalizeMessageExtra('should have the named properties, which are not undefined', message, extra)
  ...
  hasOwnProps (found, wanted, message, extra) {
    [message, extra] = normalizeMessageExtra('should have the named own properties, which are not undefined', message, extra)
